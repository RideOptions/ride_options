        ...
        body: SafeArea(
          child: Stack(
            children: [
              Column(
                children: [
                  // this portion for go back screen
                  Container(
                    width: size.width,
                    height: 170,
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            // this portion for Search Location
                            Column(
                              children: [
                                // this portion for pickup search textfield
                                Stack(
                                  children: [
                                    GestureDetector(
                                      onTap: () async {
                                        ...
                                        print(
                                            "pick up location select is: ${p?.toJson()}");
                                      },
                                      // this poriton for upper search field
                                      child: Container(
                                ...
                                // this portion for distination search textfield
                                Stack(
                                  children: [
                                    GestureDetector(
                                      onTap: () async {
                                        ...
                                        print(
                                            "destination location select is: ${p?.description}");
                                      },
                                      child: Container(
                                        width: size.width * 0.8,
                                        padding: EdgeInsets.all(15),
                        ...
                        GoogleMap(
                          ...
                          onCameraIdle: () async {
                            ...
                            String? address = await CommonFunctions()
                                .getAddressFromLatLongs(lat, lon);
                            print("address is: $address");
                            if (setLocationOnMap != null) {
                              LocationModel model = LocationModel(
                                  location: address, long: lon, lat: lat);
                              if (setLocationOnMap == "pickUp") {
                                pickupAddress = model;
                              } else {
                          ...
                          if (pickupAddress != null &&
                            ...
                            HomeProvider homeProvider =
                                Provider.of<HomeProvider>(context,
                                    listen: false);
                            homeProvider.suggestionList
                                .insert(0, destinationAddress!);
                            homeProvider.suggestionList =
                                homeProvider.suggestionList.take(6).toList();
                            await HomeService().updateRideRequestStatus(
                                userDetail!.uid!,
                                homeProvider.suggestionList
  ...
  displayPrediction(Prediction? p, bool pickUpLocation) async {
    if (p != null) {
      ...
      if (pickUpLocation) {
        ...
        destinationAddress =
            LocationModel(location: address, lat: lat, long: long);
      }
          ...
          if (value[Permission.location]?.isGranted == true) {
            ...
            if (status.isEnabled) {
              ...
              if (currentPosition != null) {
                await add(currentPosition!.latitude, currentPosition!.longitude,
                    address);
                mapNavigateOnPoints(
